...
**OpenClaw/ZeroClaw交互流程**：

- OpenClaw/ZeroClaw → 情绪分析 → 推送QuantBot → 存储分析
- 信号：QuantBot 生成建议 → 推送 OpenClaw/ZeroClaw → 通知用户
- 告警：QuantBot 触发告警 → 推送 OpenClaw/ZeroClaw → 紧急通知用户
...
- `/api/claw/news` - 接收OpenClaw/ZeroClaw新闻（Webhook）
