...
| **财报分析** | 财报获取、质量评估、异常检测、因子生成 |
| **情绪分析增强** | 社交媒体监测、多源聚合、因子融合 |
...
- `/api/financial/report` - 财报数据
- `/api/financial/quality` - 财报质量评估
- `/api/sentiment/social` - 社交媒体情绪
- `/api/sentiment/aggregate` - 情绪聚合
